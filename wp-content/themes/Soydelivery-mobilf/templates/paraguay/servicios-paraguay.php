...
<main id="site-content" role="main">
    ...
    <section class="servicios__py">
        <h2 class="servicios__py__title">Conoce más sobre nuestros servicios</h2>
        <div class="servicios__py__container">

            <div class="servicios__py__list">
                <div class="servicios__py__itemContainer1">
                    <div class="servicios__py__item">
                        <img class=""
                ...
                <div class="servicios__py__itemContainer2">
                    <div class="servicios__py__item">
                        <img class=""
        ...
        <a href="http://localhost/wordpress/cotiza-tu-servicios-paraguay/" class="btn-contactar">Contactar</a>
    </section>
</main>
