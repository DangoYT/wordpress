...
<body <?php body_class(); ?>>
	...
	<div id="body-core" class="hfeed site">
		...
		<a class="skip-link screen-reader-text"
			href="#content"><?php esc_html_e('Skip to content', 'consulting'); ?></a>
		<!-- .skip-link -->
		...
		<header>
			<div id="site-header">
				...
				<?php if (get_header_image()): ?>
					<div class="custom-header"><img src="<?php header_image(); ?>"
							width="<?php echo esc_attr(get_custom_header()->width); ?>"
							height="<?php echo esc_attr(get_custom_header()->height); ?>" alt=""></div>
