...
<body <?php body_class(); ?>>
    <header class="header-uruguay">
        <nav class="nav-uruguay">
            ...
            <div class="menu-hamburguesa-uruguay">
                <img id="hamburger-icon-uruguay"
                    src="<?php echo get_template_directory_uri(); ?>/assets/imgs/Iconos/menuHamburguesa-blanco.svg"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var hamburgerIcon = document.getElementById('hamburger-icon-uruguay');
            var navMenu = document.querySelector('.nav-uruguay ul');
