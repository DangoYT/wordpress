<!-- template-parts/slider-servicios-mobile-paises.php -->



<div class="slider__servicios__mobile-paises__container">
    <div class="slider__servicios__mobile-paises">
        <div class="slider__servicios__mobile-paises__frame-1__container">
            <div class="slider__servicios__mobile-paises__item">
                <div class="slider__servicios__mobile-paises__img__container">
                    <img class="slider__servicios__mobile-paises__img"
                        src="<?php echo get_template_directory_uri(); ?>/assets/imgs/Iconos/servicios/same-day.svg"
                        alt="">
                </div>
                <div class="slider__servicios__mobile-paises__text">
                    <h3>Same day</h3>
    ...
    <div class="slider__servicios__mobile-paises">
        <div class="slider__servicios__mobile-paises__frame-2__container">
            <div class="slider__servicios__mobile-paises__item">
                <div class="slider__servicios__mobile-paises__img__container">
                    <img class="slider__servicios__mobile-paises__img"
            ...
            <div class="slider__servicios__mobile-paises__item">
                <div class="slider__servicios__mobile-paises__img__container">
                    <img id="supermercado__img" class="slider__servicios__mobile-paises__img"
    ...
    <div class="slider__servicios__mobile-paises">
        <div class="slider__servicios__mobile-paises__frame-3__container">
            <div class="slider__servicios__mobile-paises__item">
                <div class="slider__servicios__mobile-paises__img__container">
                    <img class="slider__servicios__mobile-paises__img"
...
<script>
    jQuery(document).ready(function ($) {
        $('.slider__servicios__mobile-paises__container').slick({
            autoplay: true,
