        ...
        <div class="elcontenedordelcontenedor">
            <div class="clientes_slider_itemContainer">
                <div class="clientes_slider_item_imgContainer">
                    <img class="clientes_slider_itemImg" src="<?php echo get_template_directory_uri(); ?>/images/UB.png"
                        alt="">
                </div>
            ...
            <div class="clientes_slider_itemContainer">
                <div class="clientes_slider_item_imgContainer">
                    <img class="clientes_slider_itemImg"
                        src="<?php echo get_template_directory_uri(); ?>/images/thechemistlook.png" alt="">
                </div>
    ...
    <div class="clientes_slider__item">
        <div class="elcontenedordelcontenedor">
            <div class="clientes_slider_itemContainer">
                <div class="clientes_slider_item_imgContainer">
                    <img class="clientes_slider_itemImg"
                        src="<?php echo get_template_directory_uri(); ?>/images/clicshop.png" alt="">
                </div>
    ...
    <div class="clientes_slider__item">
        <div class="elcontenedordelcontenedor">
            <div class="clientes_slider_itemContainer">
                <div class="clientes_slider_item_imgContainer">
                    <img class="clientes_slider_itemImg"
                        src="<?php echo get_template_directory_uri(); ?>/images/copacabana.png" alt="">
                </div>
    ...
    <div class="clientes_slider__item">
        <div class="elcontenedordelcontenedor">
            <div class="clientes_slider_itemContainer">
                <div class="clientes_slider_item_imgContainer">
                    <img class="clientes_slider_itemImg"
                        src="<?php echo get_template_directory_uri(); ?>/images/thaleslab.png" alt="">
                </div>
    ...
    <div class="clientes_slider__item">
        <div class="elcontenedordelcontenedor">
            <div class="clientes_slider_itemContainer">
                <div class="clientes_slider_item_imgContainer">
                    <img class="clientes_slider_itemImg"
                        src="<?php echo get_template_directory_uri(); ?>/images/zonatecno.png" alt="">
                </div>
